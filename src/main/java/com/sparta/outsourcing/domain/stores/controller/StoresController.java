...
public class StoresController {
    ...
    @PostMapping("/stores")
    public StoreResponseDto createStore(@RequestBody StoreCreatedRequestDto storeCreatedRequestDto, @AuthenticationPrincipal CustomUserDetails userDetails){
        return storesService.createStore(storeCreatedRequestDto, userDetails);
    }
